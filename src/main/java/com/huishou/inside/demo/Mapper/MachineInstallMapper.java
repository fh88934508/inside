...
public interface MachineInstallMapper {
    ...
    List<Map<String,String>> getTitleListStep1(Integer current,String site);
...
//    List<Map<String,String>> getTitleListStep(Integer current);
    ...
    void updatedebug(String id, String remark);
    ...
    void updateinstall( String id, String remark,String machineno);
    ...
    void updateRepair(String id, String terrace_progress);
